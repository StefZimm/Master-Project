...
ui <- 
  tagList( #needed for shinyjs
    ...
    navbarPage(id = "intabset", #needed for landing page
               ...
               windowTitle = "SOEPInsights", #title for browser tab
                             ...
                             column(4, class="landing-page-column",
                                    introBox(
                                      lp_main_box(image_name= "landing_button_emp",
                                                  ...
                                                  description = 'Explore how employment changes over time'))
                             ) #introBox 7 close
                           ), # fluid row close
                             ...
                             column(4, class="landing-page-column",
                                    ...
                                    introBox( # tour of the tool
                                      lp_main_box(image_name= "landing_button_data",
                                                  ...
                                                  title_box = "Heatmap",
                                                  description = 'Take a look at the data using a map of Germany.'),
                                      data.position = "bottom-right-aligned"))),
...
tabPanel("Heatmap", icon = icon("table"), value = "report",
         ...
         sidebarPanel(width = 2,
                      ...
                      div(style = "margin-top: 30px",
                          selectInput("heatmap_variable", label = "Select a variable",
           ...
           tabPanel("How to use this tool", value = "info_page",
                    ...
                    mainPanel(width = 10,
                              fluidRow(p(h1("Welcome to the SOEP data tool"),
                                         ...
                                         br(),
                                         br(),
                                         h4("When you click on a topic, such as'Health and Care', you will be taken to a page that contains the variables (questions)
                                         ...
                                         br(),
                                         br(),
                                         h4("To veiw more information about the variable you have selected, click on the Variable Information button above the graph. A box will pop up with a brief 
                                            description and/or links to a web page that will provide more information about the variable."),
                                         br(),
                                         img(src = 'varInfo.png', height = 130, width = 300),
                                         br(),
                                         br(),
...
server <- function(input, output, session) {
  ...
  inc_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , inc_variable(), "/", inc_table()), 
                    encoding = "UTF-8")
 ...
 #### health panel ##############
  ...
  health_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , health_variable(), "/", health_table()), 
                    encoding = "UTF-8")
  ...
  att_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , att_variable(), "/", att_table()), 
                    encoding = "UTF-8")
  ...
  home_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , home_variable(), "/", home_table()), 
                    encoding = "UTF-8")
  ...
  time_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , time_variable(), "/", time_table()), 
                    encoding = "UTF-8")
  ...
  emp_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , emp_variable(), "/", emp_table()), 
                    encoding = "UTF-8")
  ...
  heatmap_data <- reactive({
    ...
    tbl <- read.csv(paste0(mainurl, type, "/" , heatmap_variable(), "/", heatmap_table()),
                    encoding = "UTF-8")
    return(tbl)
  })
